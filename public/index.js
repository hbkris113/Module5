...
function handleSubmit(e) {
    ...
    axios.post('http://localhost:4050/cities', body)
        .then(() => {
...
function deleteCard(id) {
    axios.delete(`http://localhost:4050/cities/${id}`)
        .then(() => getCities())
...
function getCities() {
    ...
    axios.get('http://localhost:4050/cities/')
        .then(res => {
...
function getCountries() {
    axios.get('http://localhost:4050/countries')
        .then(res => {
